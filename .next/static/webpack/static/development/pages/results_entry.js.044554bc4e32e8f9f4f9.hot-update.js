...
function rankFunction(results, athletes) {
  var p = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (res, reject) {
    var kidArray = getAgeArray(athletes, 6, 8);
    ...
    for (var a = 0; a < kidArray.length; a++) {
      ...
      if (resultMatch == true) {
        ...
        kidArray[k].tieOB = '';
        kidArray[k].tieTime = '';
        kidArray[k].resultStr = '';
        kidArray[k].completed = false;
        kidArray[k].rank = 100;
      }
...
//# sourceMappingURL=results_entry.js.044554bc4e32e8f9f4f9.hot-update.js.map