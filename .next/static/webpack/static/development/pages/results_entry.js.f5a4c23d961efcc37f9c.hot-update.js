...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Stopwatch, [{
    ...
    value: function start() {
      ...
      var start = _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()();
      ...
      this.setState({
        ...
        _this2.timerRef = setInterval(function () {
          //  this.updateTimer( 10 ) 
          var delta = _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_0___default()() - start; // milliseconds elapsed since start

          _this2.updateTimer(Math.floor(delta / 1000));
        }, 1000);
      });
    }
  }, {
...
//# sourceMappingURL=results_entry.js.f5a4c23d961efcc37f9c.hot-update.js.map