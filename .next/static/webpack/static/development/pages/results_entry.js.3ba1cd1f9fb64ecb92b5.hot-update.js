    ...
    value: function start() {
      ...
      this.setState({
        ...
        _this2.timerRef = setInterval(function () {
          //  this.updateTimer( 10 ) 
          if (_this2.state.stopTime != 0) {
            _this2.state.restartTime = _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_5___default()();
            _this2.state.adjustedTime += _this2.state.restartTime - _this2.state.stopTime;
          }
...
//# sourceMappingURL=results_entry.js.3ba1cd1f9fb64ecb92b5.hot-update.js.map