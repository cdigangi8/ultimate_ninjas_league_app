  ...
  for (var a = 0; a < arr.length; a++) {
    ...
    if (newRank == true) {
      ...
      for (var c = 0; c < arr.length; c++) {
        ...
        if (arr[c].rank != '' && arr[c].rank != null && arr[c].rank != undefined && arr[c].rank >= arr[a].rank && arr[c].rank !== arr[a].rank) {
          arr[c].rank += 1;
...
//# sourceMappingURL=results_entry.js.5ad25833fbbb8ae4321c.hot-update.js.map