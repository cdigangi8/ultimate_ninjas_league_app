...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Controls, [{
    ...
    value: function render() {
      ...
      }, this.props.obstacle), react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement(simple_flexbox__WEBPACK_IMPORTED_MODULE_8__["Row"], {
        horizontal: "center"
      }, this.props.choices.map(function (item, index) {
        return react__WEBPACK_IMPORTED_MODULE_6___default.a.createElement("div", {
          className: item.selected == true ? "obstacleBoxContent activeBox" : "obstacleBoxContent",
          onClick: addObstacleTime(item)
        }, item.value);
      }))) : null);
    }
  }]);
...
//# sourceMappingURL=results_entry.js.de091acc758f2c8a851d.hot-update.js.map