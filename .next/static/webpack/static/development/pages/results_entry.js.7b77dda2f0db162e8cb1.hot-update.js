...
function rankFunction(results, athletes) {
  var p = new _babel_runtime_corejs2_core_js_promise__WEBPACK_IMPORTED_MODULE_0___default.a(function (res, reject) {
    ...
    for (var a = 0; a < athletes.length; a++) {
      ...
      var ageMin;
      var ageMax;
      obj.first_name = athletes[a].first_name;
      obj.last_name = athletes[a].last_name;
      obj.athlete_id = athletes[a].athlete_id;
      obj.age = athletes[a].age;
      var resultMatch = checkResult(results, athletes[a].athlete_id);

      if (resultMatch == true) {
        if (athletes[a].age == 6 || athletes[a].age == 7 || athletes[a].age == 8) {
          ageMin = 6;
          ageMax = 8;
        } else if (athletes[a].age == 9 || athletes[a].age == 10) {
          ageMin = 9;
          ageMax = 10;
        } else if (athletes[a].age == 11 || athletes[a].age == 12) {
          ageMin = 11;
          ageMax = 12;
        } else if (athletes[a].age == 13 || athletes[a].age == 16) {
          ageMin = 13;
          ageMax = 16;
        }

        for (var i = 0; i < results.length; i++) {
          if (athletes[a].athlete_id == results[i].athlete_id) {
...
//# sourceMappingURL=results_entry.js.7b77dda2f0db162e8cb1.hot-update.js.map