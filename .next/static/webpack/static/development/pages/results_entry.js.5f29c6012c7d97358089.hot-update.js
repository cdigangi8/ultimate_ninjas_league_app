...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Stopwatch, [{
    ...
    value: function start() {
      ...
      this.setState({
        ...
        _this2.timerRef = setInterval(function () {
          //  this.updateTimer( 10 ) 
          console.log(_this2.state.adjustedTime);
          console.log(_this2.state.start);
          var delta = _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_5___default()() - _this2.state.start - adjustedTime; // milliseconds elapsed since start
    ...
    value: function stop() {
      ...
      this.setState({
        isRunning: false,
        adjustedTime: _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_5___default()() - this.state.start
      }, function () {
...
//# sourceMappingURL=results_entry.js.5f29c6012c7d97358089.hot-update.js.map