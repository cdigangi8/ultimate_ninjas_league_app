...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Stopwatch, [{
    ...
    value: function start() {
      ...
      this.setState({
        ...
        _this2.timerRef = setInterval(function () {
          ...
          var delta = _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_5___default()() - _this2.state.adjustedTime - _this2.state.start; // milliseconds elapsed since start
    ...
    value: function stop() {
      ...
      this.setState({
        isRunning: false,
        adjustedTime: _babel_runtime_corejs2_core_js_date_now__WEBPACK_IMPORTED_MODULE_5___default()()
      }, function () {
...
//# sourceMappingURL=results_entry.js.33fb46b7b0e77a2dff63.hot-update.js.map